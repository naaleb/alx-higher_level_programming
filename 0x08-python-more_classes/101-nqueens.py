#!/usr/bin/python3
""" A script to solves the N-queens puzzle.

Determine all possible solutions to placing N,
...
The solutions are represented in a format [[r, c], [r, c], [r, c], [r, c]]
where `r` and `c` represent the row and column, respectively whereby a
...
def get_solution(board):
    """Returns a list of lists representing a solved chessboard."""
    solution = []
