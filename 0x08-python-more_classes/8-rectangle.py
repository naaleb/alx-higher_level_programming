...
class Rectangle:
    ...
    Attributes:
        number_of_instances (int): Number of a Rectangle instances.
    ...
    def __str__(self):
        """Return a diagram representation of a Rectangle.
    ...
    def __repr__(self):
        """Return a string representating a Rectangle."""
        rect = "Rectangle(" + str(self.__width)
        rect += ", " + str(self.__height) + ")"
        return (rect)

    def __del__(self):
        """Print a message showing every deletion of a Rectangle."""
        type(self).number_of_instances -= 1
        print("Bye rectangle...")
